...
import Product, {ProductNumbering,TextAndPrices, CatalogProduct, BuyProduct} from "../components/Product";
...
export default function Home({ navigation }) {
    ...
    return (
        <Box width="100%" height="100%" justifyContent="center" alignItems="center">
            ...
            <BuyProduct name="Sample" price={1000} description="Please buy this beautiful landscape picture I'm begging I'm poor." />
        </Box>
    )
}
